...
const CLASSES = {
  ...
  actionBtnPush: 'group cursor-pointer h-14 w-full rounded-full border border-violet-400 bg-violet-200 px-3 text-xs font-semibold uppercase tracking-wide text-violet-950 transition-colors duration-200 enabled:hover:bg-violet-300 enabled:active:bg-violet-400 disabled:cursor-default disabled:opacity-50 dark:border-violet-500 dark:bg-violet-600 dark:text-white dark:enabled:hover:bg-violet-500 dark:enabled:active:bg-violet-400',
